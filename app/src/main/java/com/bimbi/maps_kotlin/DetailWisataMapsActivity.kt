...
import com.bimbi.maps_kotlin.databinding.ActivityDetailWisataMapsBinding
...
class DetailWisataMapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val deksripsiWisata = intent.getStringExtra("deskripsiWisata")
        ...
        tvDeskripsi.text = deksripsiWisata
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(koordinatWisata, 15.0f))
    }
}